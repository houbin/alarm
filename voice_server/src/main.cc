...
int run_master()
{
    ...
    json_master_option.worker_count_ = 1;
    json_master_option.worker_conn_count_ = 5000;
    ...
    json_master = new Master("json_master", json_master_option);
    ...
    tlv_master_option.worker_count_ = 1;
    tlv_master_option.worker_conn_count_ = 5000;
    ...
    json_master = new Master("tlv_master", tlv_master_option);
...
int main()
{
    ...
    string default_log_path("/var/log/voice_server/");
    log_path = g_config->Read("log_path", default_log_path);
    log_level = g_config->Read("log_level", log_level);
